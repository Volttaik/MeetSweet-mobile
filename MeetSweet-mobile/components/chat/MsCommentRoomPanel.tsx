...
function MsCommentIn({ animateOnMount, enabled = true, children }: MsCommentInProps) {
  const anim = useRef(new Animated.Value(animateOnMount && enabled ? 0 : 1)).current;
  useEffect(() => {
